...
https://sparkbyexamples.com/r-programming/r-str-replace-to-replace-matched-patterns-in-a-string/
```{r}
unique(cdf_2$colour)
...
### Export out the file
```{r}
#write_csv(cdf_7, "cleaned_catdog_data_v1.csv")

```


## Pivot to long form
Not actually that relevant for this dataset but is useful in other cases
```{r}
long_df <- cdf_8 %>%
  select(!file_id) %>%
